    ...
    <div class="nav-stick" id="navtop">
        <div class="nentren">
            ...
            <div class="container">
                ...
                <div class="acount ">
                    <button><a href="{{ route('FormLoginAdmin') }}">Đăng Nhập</a></button>&nbsp;&nbsp;
                    <button><a href="{{ route('TrangDangKi') }}">Đăng Kí</a></button>
                </div>
            </div>
        </div>
        <div class="nen">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse " id="navbarSupportedContent">
                                    ...
                                    <ul class="dropdown-menu dropstyle" aria-labelledby="navbarDropdown">
                                        <div class="table-drop row">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="{{ route('xemtheodanhmuc', [$tendm->id, $tendm->slugdm]) }}"><i style="font-size:20px"class="bi bi-tag"></i>{{ $tendm->danhmuc }}</a>
                                                </li>
                                            </div>
                                            @endforeach
                                ...
                                <li class="nav-item py-2">
                                    ...
                                    <ul class="dropdown-menu dropstyle" aria-labelledby="navbarDropdown">
                                        <div class="table-drop row">
                                                ...
                                                <div class="col-3">
                                                <li><a class="dropdown-item"
                                                        href="{{ route('xemtheotheloai', [$item->id, $item->slugtl]) }}"><i style="font-size:20px"class="bi bi-tag"></i>{{ $item->theloai }}</a>
                                                </li>
                                            </div>
                                            @endforeach
                            ...
                            {{-- /           ///////tìm kiếm///////// --}}
                            <form autocomplete="off" class="d-flex" action="{{ route('timkiem') }}"
                                method="GET">
                                @csrf
                                <div class="timkiem">
