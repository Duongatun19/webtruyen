...
<div class="col-9  reponsive-col9">
        <div class="row nav-bread reponsive-col9">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="">
                <ol class="breadcrumb">
                    ...
                    @foreach ($tl as $item)
                        <li class="breadcrumb-item active" aria-current="page">{{ $item->theloai }}</li>
        ...
        <div class="row reponsive-col9 wow fadeInLeft bgnew" data-wow-delay="0.8s" data-wow-duration="2s">
            <div class="styleh3 px-3 py-2">
                <h3>Thể Loại : {{ $item->theloai }}</h3>

            </div>
            @endforeach

            @php
                $count = count($truyen->tl_Truyens);
            ...
            @else
                ...
                @foreach ($truyen->tl_Truyens as $item)
                        ...
                        <div class="product-card d-flex flex-row align-items-center">
                            ...
                            <div class="noidung">
                                <div class=" div-one px-2 py-2">
                                    <div class="">
                                    <h5 class="mb-1">{{ $item->name_product }}
                                    </h5>
                                </div>
                                <div><i class="bi bi-heart-fill"></i></div>
                                    ...
                                    <div class=" style-dm size-edit">
                                        ...
                                        <div class="mini-dm py-1"><a href="">{{ $danhmucs->danhmuc }}  </a></div>
                                       @endforeach
                                    </div>
                                       
                                        <div class="  style-dm size-edit">
                                            @foreach ($item->thuocnhieutheloaitruyen as $theloais)
                                            <div class="mini-tl py-1"><a href="" class="tag-new">{{ $theloais->theloai }}  </a></div>
                                           @endforeach
                                        </div>
