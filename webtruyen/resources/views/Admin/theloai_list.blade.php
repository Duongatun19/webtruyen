...
@endif
            <div class="mb-3 ">
                <input type="text" name="theloai" value="{{old('name_theloai')}}"class="form-control" placeholder="Enter Name" id="slug"
                ...
                <tbody>
                    @foreach ($all_theloai as $tl)
                        <tr>
                            ...
                            <td>
                                <div class="thaotac">
                                    <button><a href="{{ route('edit_tl', $tl->id) }}"
                                            class="btn-sua"><i
                                                class="fa-solid fa-wrench"></i></a></button>&nbsp;&nbsp;
                                    <form action="{{ route('delete_tl', $tl->id) }}" method="post"
                                        class="dele">
                                        @csrf
                                        @method('DELETE')
